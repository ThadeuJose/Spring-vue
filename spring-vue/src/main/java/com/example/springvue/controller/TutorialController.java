...
import com.example.springvue.data.model.Tutorial;
import com.example.springvue.repository.TutorialRepository;
...
public class TutorialController {
    ...
    public ResponseEntity<Tutorial> createTutorial(@RequestBody Tutorial tutorial) {
        try {
            ...
            Tutorial createdTutorial = tutorialRepository.save(newTutorial);
